// const helperFunctions = require('./SchedulerHelperFunctions')
...
//
//     let timeList = await helperFunctions.kickstartGenerateTimesFunction({
...
//     });
//
//     if (helperFunctions.givenTimeIsInList({
//         partyPackage: partyPackage,
//         roomsRequested: roomsRequested,
//         roomTimes: roomTimes,
//         testTimes: timeList
